                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () =>
                      _globalbase.musicPlayerBase.playPreviousSong(),
                      child: Icon(
                        Icons.fast_rewind,
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () => _globalbase.musicPlayerBase.playNextSong(),
                      child: Icon(
                        Icons.fast_forward,
                        color: Color(0xFF7B92CA),
                        size: 40,
                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    if(PlayerState.paused == _state){
                      _globalbase.musicPlayerBase.playMusic(_currentSong);
                    }else {
                      _globalbase.musicPlayerBase.pauseMusic(_currentSong);
                    }
                  },
                  child: Container(
                    width: 100,

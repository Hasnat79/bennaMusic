...
import 'package:benna_music/src/controls/album.dart';
...
class MusicPlayerBase{
  ...
  BehaviorSubject<List<Album>> get album$ => _albums$;
  ...
  MusicPlayerBase(){ //starts the music player, constructor
    _initDefaultSong();
    _initStreams();
    _initObservers();
    _initAudioPlayer();
